# BFS Dispatch (BestFreight System)

Sistema integral de gestión de despacho de carga (freight dispatch management). Diseñado para dispatchers, carriers y conductores con módulos web completos y visión de expansión móvil.
